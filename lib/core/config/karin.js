...
import { YamlEditor, logger, Cfg } from 'node-karin';
...
function getKarinAssociated(view, file) {
    let associated = [];
...
* @returns {object} 配置信息
*/
export function getKarinConfig(file) {
    ...
    const current = { ...karinDefaultConfig, ...karinConfig }.document.contents;
    let configs = [];
...
*/
export function setKarinConfig(file, key, value) {
